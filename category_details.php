	...
	<div class="col-md-9">
		<div class="row" style="padding:0px 0px 10px 0px;">
			<?php
				...
				$res1 = mysqli_query("select * from products_category where id = '$cat_id'");
			...
			<?php
				...
				$id= 1;				
				$res1 = mysqli_query("select * from products_manage where cetagory_id = '$cat_id' order by id desc");
