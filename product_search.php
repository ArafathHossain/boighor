		...
		<div class="row" style="padding:0px 0px 10px 0px;">
			...
			<?php
			 if($search_field !=''){
				...
				$q001 = mysqli_query("select * from products_manage where name like '%$search_field%' or product_code like '%$search_field%' order by id desc");
				while($row = mysqli_fetch_array($q001)){
				$pro_id 				= $row['id'];
				$name 					= $row['name'];
