	...
	<div class="col-md-10">
		<div class="row" style="padding:0px 0px 10px 0px;">
			<?php
				...
				$res1 					= mysqli_query("select * from products_category where id = '$subdetails_id'");
			...
			<?php
				...
				$id= 1;
        $p2 = mysqli_query("select id from products_sub_category where cat_id = '$subdetails_id'");
  			while($q2 = mysqli_fetch_array($p2))
  			{
  			$ID = $q2['id'];
				$res1 = mysqli_query("select * from products_manage where sub_cat_id = '$ID' order by id desc");
